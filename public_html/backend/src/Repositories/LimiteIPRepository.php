...
class LimiteIPRepository
{
    ...
    /**
     * Incrementar contador de consultas do IP
     */
    public function incrementarConsulta(string $ip): bool
    {
        ...
        if ($limiteIP) {
            ...
            // Criar novo registro
            $sql = "INSERT INTO limites_ip (ip, consultas_hoje, primeira_consulta_em, ultima_consulta_em)
                    VALUES (:ip, 1, NOW(), NOW())";
